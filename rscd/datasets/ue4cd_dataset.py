...
import numpy as np
class UE4CD(BaseDataset):
    def __init__(self, data_root='data/UE4CD', mode='train', transform=None, imgA_dir='time1', imgB_dir='time2', mask_dir='label', img_suffix='.png', mask_suffix='.png', **kwargs):
        super(UE4CD, self).__init__(transform, mode)
